      ...
      <div className="container mx-auto px-5 py-3 md:px-6 md:py-3.5">
        <div className="flex items-center justify-center">
          ...
          <div className="hidden md:flex items-center gap-12">
            ...
            <Button size="lg" className="shadow-soft hover:shadow-glow hover:scale-105 transition-all duration-300 font-semibold bg-gradient-to-r from-amber-500 to-orange-600 text-white hover:from-amber-600 hover:to-orange-700" asChild>
