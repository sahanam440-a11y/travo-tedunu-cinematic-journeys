...
const Navbar = () => {
  ...
  return (
    <nav className="hidden md:block fixed top-12 left-0 right-0 z-50 shadow-elevated border-b border-nav-border backdrop-blur-md transition-transform duration-300 bg-nav-background/95">
